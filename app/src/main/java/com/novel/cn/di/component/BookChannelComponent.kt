 ...
 */
@FragmentScope
@Component(modules = arrayOf(BookChannelModule::class), dependencies = arrayOf(AppComponent::class))
interface BookChannelComponent {
    fun inject(fragment: BookChannelFragment)
}
