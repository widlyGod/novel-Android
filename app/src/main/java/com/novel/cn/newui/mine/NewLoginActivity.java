package com.novel.cn.newui.mine;
...
import com.novel.cn.ui.ForgetPasswordActivity;
...
public class NewLoginActivity extends AutoLayoutActivity implements LoginContract.View{
    ...
    @OnClick({R.id.iv_left, R.id.iv_qq, R.id.iv_wx, R.id.iv_wb,R.id.tv_yhzcxy,R.id.tv_forpw,R.id.btn_LoginOrRes})
...
//        other.SSOSetting(false);//优先选择调用手机客户端界面   true是网页界面
        other.setPlatformActionListener(new PlatformActionListener() {
            ...
            public void onComplete(Platform platform, int i, HashMap<String, Object> hashMap) {
                ...
                NewLoginActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        dialog_loading.show();
            ...
            public void onError(Platform platform, int i, Throwable throwable) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (typex == 0 && ix == 1) {
                            Toast.makeText(NewLoginActivity.this, "qq客户端不存在", Toast.LENGTH_SHORT).show();
                        } else if (typex == 1 && ix == 8) {
                            Toast.makeText(NewLoginActivity.this, "微信客户端不存在", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(NewLoginActivity.this, "错误", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
        ...
        Observable.combineLatest(etAmoutMoney, tvAddress, new Func2<CharSequence, CharSequence, Boolean>() {
            ...
            public void call(Boolean aBoolean) {
                ...
                if (aBoolean) {
                    ...
                    btn_LoginOrRes.setBackground(ContextCompat.getDrawable(NewLoginActivity.this, R.drawable.shape_login_conbtn));
                    String userName = etUsername.getText().toString();
                    String pw = etPw.getText().toString();
                    if (PartsUtil.isEmail(userName) == false ) {
                        tv_messagelogin.setText("用户名格式不正确");
...
//                        errorText="";
                    ...
                    btn_LoginOrRes.setBackground(ContextCompat.getDrawable(NewLoginActivity.this, R.drawable.shape_login_btn));
                    tv_messagelogin.setText("");
//                    errorText="";
                }
            }
    ...
    public void loginSuccess(BaseObjectBean<UserBean> data) {
        ...
        if(data.isSuccess()){
            SharePrefUtil.saveBoolean(NewLoginActivity.this, "isLogin", true);
