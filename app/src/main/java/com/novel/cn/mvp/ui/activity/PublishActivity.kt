 ...
 * }
 */
class PublishActivity : BaseActivity<PublishPresenter>(), PublishContract.View, PoiSearch.OnPoiSearchListener {
    ...
    private fun initLocation() {
        poiSearch = PoiSearch(this, PoiSearch.Query("", ""))
        ...
        if (null != location) {
            ...
            if (location.errorCode == 0) {
                poiSearch.bound = PoiSearch.SearchBound(LatLonPoint(location.latitude,
                        location.longitude), 100)//设置周边搜索的中心点以及半径
