...
public class DateUtil {
	...
	public static String getNoZerData(String oldData){
		String year=oldData.substring(0,5);
		String month=oldData.substring(5,8);
		if(month.substring(0,1).equals("0")){
			month=month.substring(1,3);
		}
		String day=oldData.substring(8,10);
	...
	public static String getYYYYMMDD(String oldData){
		SimpleDateFormat sdf2M = new SimpleDateFormat("yyyy-MM-dd");
		try {
			Date strx=sdf2M.parse(oldData);
			String dateString = sdf2M.format(strx);
			return dateString;
	 ...
	 * @return
	 * 
	 *         2014-12-forgetpstwo 下午06:45:02 段
	 * 
	 * @return String
	 */
