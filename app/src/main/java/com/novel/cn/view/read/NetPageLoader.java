...
import static com.novel.cn.view.read.PageLoader.Status.STATUS_LOADING;

public class NetPageLoader extends PageLoader {

    public NetPageLoader(ReadView view, int width, int height) {
    ...
    @Override
    BufferedReader getChapterReader(TxtChapter txtChapter) throws FileNotFoundException {
    ...
    @Override
    boolean hasChapterData(TxtChapter txtChapter) {
        return true;
    }
